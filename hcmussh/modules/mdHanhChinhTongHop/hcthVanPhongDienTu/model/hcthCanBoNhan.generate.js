// Table name: HCTH_CAN_BO_NHAN { id, canBoNhan, loai, ma, vaiTro, nguoiTao, trangThai, ordinal }
const keys = ['ID'];
const obj2Db = { 'id': 'ID', 'canBoNhan': 'CAN_BO_NHAN', 'loai': 'LOAI', 'ma': 'MA', 'vaiTro': 'VAI_TRO', 'nguoiTao': 'NGUOI_TAO', 'trangThai': 'TRANG_THAI', 'ordinal': 'ORDINAL' };

module.exports = app => {
    const db = 'main';
    const tableName = 'HCTH_CAN_BO_NHAN';
    const type = 'table';
    const schema = {
        ID: {
            type: 'NUMBER',
    ...
    const methods = {
        'getAllCanBoNhan': 'HCTH_GIAO_NHIEM_VU_GET_ALL_CAN_BO_NHAN',
        'getAllFrom': 'HCTH_CAN_BO_NHAN_GET_ALL_FROM'
    };
