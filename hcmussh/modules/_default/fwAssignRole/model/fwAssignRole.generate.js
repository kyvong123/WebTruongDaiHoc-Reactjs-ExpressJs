// Table name: FW_ASSIGN_ROLE { id, nguoiGan, nguoiDuocGan, ngayBatDau, ngayKetThuc, tenRole, nhomRole, nhomRoleId }
const keys = ['ID'];
const obj2Db = { 'id': 'ID', 'nguoiGan': 'NGUOI_GAN', 'nguoiDuocGan': 'NGUOI_DUOC_GAN', 'ngayBatDau': 'NGAY_BAT_DAU', 'ngayKetThuc': 'NGAY_KET_THUC', 'tenRole': 'TEN_ROLE', 'nhomRole': 'NHOM_ROLE', 'nhomRoleId': 'NHOM_ROLE_ID' };

module.exports = app => {
    const db = 'main';
    const tableName = 'FW_ASSIGN_ROLE';
    const type = 'table';
    const schema = {
        ID: {
            type: 'NUMBER',
    ...
    const methods = {
        'getCurrentRoles': 'FW_ASSIGN_ROLE_GET_CURRENT_ROLES'
    };
