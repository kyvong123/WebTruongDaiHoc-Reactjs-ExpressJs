...
class HocPhanNgoaiCTDTTab extends HocPhanSection {
    ...
    render() {
        ...
        return (<div className='tile'>
            <HocPhanModal ref={e => this.nctdtModal = e} loading={this.props.loading} cauHinh={this.props.cauHinh} userData={this.props.userData}
                cauHinhDiem={this.props.cauHinhDiem} cauHinhTKB={this.props.cauHinhTKB} configDispatch={this.props.configDispatch} />
