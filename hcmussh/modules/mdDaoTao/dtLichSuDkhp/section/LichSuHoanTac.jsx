...
class LichSuHoanTac extends AdminPage {
    state = {
    ...
    getLichSu = (done) => {
        this.setState({ filter: { ...this.props.filter, thaoTac: 'H' } }, () => {
                ...
                return (
                    <tr key={index}>
                        ...
                        <TableCell style={{ whiteSpace: 'nowrap', textAlign: 'center' }} content={
                            <div style={{ color: 'orange' }}><i className='fa fa-lg fa-undo' /> Hoàn tác </div>
                        } />
                        <TableCell style={{ whiteSpace: 'nowrap', textAlign: 'left' }} content={item.thaoTac} />
                    </tr>
                );
            }
        });
...
export default connect(null, mapActionsToProps, null, { forwardRef: true })(LichSuHoanTac);