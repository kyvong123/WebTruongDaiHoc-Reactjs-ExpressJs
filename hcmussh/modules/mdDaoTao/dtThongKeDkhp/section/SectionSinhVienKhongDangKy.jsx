...
class SectionSinhVienKhongDangKy extends React.Component {
    ...
    downloadExcel = (e) => {
        ...
        T.handleDownload(`/api/dt/thong-ke-dkhp/ds-khong-dang-ky/download?filter=${filter}`,
            'Thong_ke_DSSV_khong_DKTC.xlsx');
    }

    getPage = (pageN, pageS, pageC, done) => {
        let filter = { ...this.state.filter, ...this.state.ksSearch, sort: this.state?.sortTerm || this.defaultSortTerm, isDangKy: 0 };
        ...
        let table = renderDataTable({
            ...
            renderHead: () => (
                <tr>
                    ...
                    <TableHead style={{ width: '30%', whiteSpace: 'nowrap', textAlign: 'center' }} content='Ngành' keyCol='nganh' onKeySearch={this.handleKeySearch} onSort={this.onSort} />
                    <TableHead style={{ width: '15%', whiteSpace: 'nowrap', textAlign: 'center' }} content='Khóa' keyCol='khoaSinhVien' onKeySearch={this.handleKeySearch} onSort={this.onSort} />
                </tr>),
...
export default connect(mapStateToProps, mapActionsToProps, null, { forwardRef: true })(SectionSinhVienKhongDangKy);