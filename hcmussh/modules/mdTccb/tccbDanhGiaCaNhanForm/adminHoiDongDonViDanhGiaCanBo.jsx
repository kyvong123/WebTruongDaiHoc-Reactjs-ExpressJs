...
class FormChuyenVienDetails extends AdminPage {
    ...
    componentDidMount() {
        T.ready('/user/tccb', () => {
            const route = T.routeMatcher('/user/tccb/hoi-dong-danh-gia-don-vi/:nam/:shcc');
    ...
    render() {
        ...
        const isHoiDongDanhGia = danhGiaNamSetting.donViBatDauDanhGia && danhGiaNamSetting.donViKetThucDanhGia && currentDate >= danhGiaNamSetting.donViBatDauDanhGia && currentDate <= danhGiaNamSetting.donViKetThucDanhGia;
                            ...
                            if (noiDung.loaiCongViec == 1) {
                                return <React.Fragment key={`${index}-${sttNoiDung}`}>
                                    ...
                                    <tr>
                                        ...
                                        <TableCell style={{ textAlign: 'right' }} content={<b>{`${noiDung.totalDonVi} điểm`}</b>} />
                                        <TableCell style={{ textAlign: 'center' }} />
                                        <TableCell style={{ textAlign: 'center' }} />
                                    </tr>
                                </React.Fragment>;
                                    ...
                                    {noiDung.submenus?.map((menu, sttMenu) => (
                                        <tr key={`${index}-${sttNoiDung}-${sttMenu}`}>
                                            ...
                                            <TableCell type='buttons' style={{ textAlign: 'right' }}>
                                                {isHoiDongDanhGia ? (
                                                    <Tooltip title='Đánh giá' arrow>
                                                        <button className='btn btn-primary' onClick={() => this.danhGiaFitModal.show(menu)}>
                                                            <i className='fa fa-lg fa-commenting-o' />
                                                        </button>
                                                    </Tooltip>
                                                ) : null}
