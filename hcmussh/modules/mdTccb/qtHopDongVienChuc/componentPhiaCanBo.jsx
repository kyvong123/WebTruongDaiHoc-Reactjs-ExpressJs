...
import { getStaffByEmail, getStaffEdit, SelectAdapter_FwCanBo } from 'modules/mdTccb/tccbCanBo/redux';
...
export class ComponentPhiaCanBo extends React.Component {
    ...
    getIsCanBoCu = () => this.state.isCanBoCu;
            ...
            <div className='tile'>
                    ...
                    !this.state.isTaoMoi ?
                        ...
                        <>
                            <h3 className='tile-title' style={{ display: 'flex' }}>Thông tin phía&nbsp;&nbsp;
                                <Dropdown ref={e => this.typeFilter = e} items={[...Object.keys(EnumLoaiCanBo).map(key => EnumLoaiCanBo[key].text)]}
                                    onSelected={item => item == 'Cán bộ mới' ? this.setState({ isCanBoCu: false }) : this.setState({ isCanBoCu: true })} />
                            </h3>
                        </>
                }
                <div className='tile-body row'>
                    {(this.state.isCanBoCu || !this.state.isTaoMoi) ?
                        <>
                            <FormSelect ref={e => this.canBo = e} data={SelectAdapter_FwCanBo} className='col-xl-5 col-md-6' label='Cán bộ' onChange={this.handleCanBoChange}
                                readOnly={!this.state.isTaoMoi ? readOnly : readOnly} required />
                        ...
                        <>
                            ...
                            <FormTextBox ref={e => this.ho = e} label='Họ và tên lót' style={{ textTransform: 'uppercase' }} className='col-xl-3 col-md-6' onChange={this.handleHo} readOnly={readOnly}
                                required maxLength={100} />
                            <FormTextBox ref={e => this.ten = e} label='Tên' style={{ textTransform: 'uppercase' }} className='col-xl-3 col-md-6' onChange={this.handleTen} readOnly={readOnly} required
                                maxLength={100} />
                    ...
                    <FormSelect data={SelectAdapter_DmTonGiaoV2} className='col-xl-4 col-md-4' readOnly={readOnly} ref={e => this.tonGiao = e} label='Tôn giáo' />
