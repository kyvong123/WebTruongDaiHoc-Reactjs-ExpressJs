...
import { renderDataTable, TableCell, TableHead, AdminModal, loadSpinner, FormSelect } from 'view/component/AdminPage';
import { getSdhDangKyHocPhanItem, getHocPhan } from 'modules/mdSauDaiHoc/sdhDangKyHocPhan/redux';
import { connect } from 'react-redux';
import { SelectAdapter_DmHocSdhVer2 } from 'modules/mdSauDaiHoc/dmHocSdh/redux';
import { SelectAdapter_SdhKhoaDaoTao } from 'modules/mdSauDaiHoc/sdhKhoaDaoTao/redux';
import { SelectAdapter_SdhLopHocVien } from 'modules/mdSauDaiHoc/sdhLopHocVien/redux';
import { SelectAdapter_DmKhoaSdh } from 'modules/mdSauDaiHoc/dmKhoaSauDaiHoc/redux';
class SdhDkttHocPhanModal extends AdminModal {
    ...
    onSave = () => {
        let { hocPhanChon, currHocPhan } = this.state;
        if (hocPhanChon) {
        ...
        return this.renderModal({
            ...
            body: <>
                <div className='row'>
                    ...
                    />
                    <FormSelect ref={(e) => (this.khoaSinhVien = e)} className='col-md-2' label='Khoá sinh viên' data={SelectAdapter_SdhKhoaDaoTao}
                        onChange={(value) =>
                            this.setState({
                    ...
                    />
                    <FormSelect ref={(e) => (this.lopSV = e)} className='col-md-2' label='Lớp' data={SelectAdapter_SdhLopHocVien}
                        onChange={(value) =>
                            this.setState({
                    ...
                    <div className='col-md-12'>
                        {this.state.listHocPhan ? this.table(this.state.listHocPhan) : loadSpinner()}
                    </div>
                </div>
...
const mapActionsToProps = { getSdhDangKyHocPhanItem, getHocPhan };
export default connect(mapStateToProps, mapActionsToProps, null, { forwardRef: true })(SdhDkttHocPhanModal);
