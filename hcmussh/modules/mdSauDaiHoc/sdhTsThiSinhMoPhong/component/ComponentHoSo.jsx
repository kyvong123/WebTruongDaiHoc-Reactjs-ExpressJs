...
class ThiSinhTuyenSinhSdhPage extends AdminPage {
    ...
    render() {
        ...
        return loading ? <OverlayLoading text='Loading..' /> :
            active ? <>
                ...
                <FormChildren title='Thông tin cơ bản' className='tile' titleClassName='tile-title' showing={onShow.ttcb} content={<>
                    <div className='row'>
                        ...
                        <FormSelect ref={e => this.danToc = e} label='Dân tộc' data={SelectAdapter_BmdkDanToc} className='col-md-3' readOnly={readOnly} required />
