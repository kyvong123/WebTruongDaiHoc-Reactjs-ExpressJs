...
class ThiSinhTrungTuyenPage extends AdminPage {
    ...
    getData = () => {
        ...
        this.props.getSdhTsTrungTuyenThiSinh(user.idThiSinh, listResult =>
...
export default connect(mapStateToProps, mapActionsToProps, null, { forwardRef: true })(ThiSinhTrungTuyenPage);
