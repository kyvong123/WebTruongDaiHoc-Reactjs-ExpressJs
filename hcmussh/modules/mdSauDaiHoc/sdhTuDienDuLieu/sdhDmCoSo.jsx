...
class SdhCoSoPage extends AdminPage {
...
const mapStateToProps = state => ({ system: state.system, dmCoSo: state.danhMuc.dmCoSo, sdhCoSo: state.sdh.sdhCoSo });
const mapActionsToProps = { getDmCoSoAll, createDmCoSo, updateDmCoSo, deleteDmCoSo };
export default connect(mapStateToProps, mapActionsToProps)(SdhCoSoPage);