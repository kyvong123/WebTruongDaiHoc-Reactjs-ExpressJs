...
class userPage extends AdminPage {
    ...
    render() {
        ...
        const table = renderTable({
            ...
            renderHead: () => (
                <tr>
                    ...
                    <th style={{ width: 'auto', whiteSpace: 'nowrap' }} >Link video</th>
            ...
            renderRow: (item, index) => {
                return (
                    <tr key={index}>
                        ...
                        <TableCell type='link' contentStyle={{ width: '100%', minWidth: '300px' }} content={item.tieuDe || 'Chưa có tiêu đề'} url={`/user/affair/instruction/${item.id}`} />
                        <TableCell type='link' contentStyle={{ width: 'auto', whiteSpace: 'nowrap' }} content={item.linkVideo ? 'Link video' : ''} url={item.linkVideo} />
        ...
        return this.renderPage({
            ...
            onCreate: permission && permission.login ? () => this.props.history.push('/user/affair/instruction/new') : null,
