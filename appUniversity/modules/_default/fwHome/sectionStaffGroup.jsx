        ...
        return (
            <div className='block-2'>
                <div className='flipper'>
                    <div className='front' style={{ backgroundImage: `url(${T.cdnDomain + staff.info.image})` }}>
                        <div className='box'>
                    ...
                    <div className='back'>
                        ...
                        <div className='author d-flex'>
                            <div className='image mr-3 align-self-center'>
                                <div className='img' style={{ backgroundImage: `url(${T.cdnDomain + staff.info.image})` }}></div>
                            </div>
