...
import { SelectAdapter_DangKyHocPhanStudentSdh } from '../sdhDangKyHocPhan/redux';
import ImportSinhVienSdhModal from './importSvSdhPage';
import { getLopCommonPage, getSdhLopData, updateSdhLopData } from './redux';
...
class DetailPage extends AdminPage {
    ...
    componentDidMount() {
        T.ready('/user/sau-dai-hoc', () => {
            let route = T.routeMatcher('/user/sau-dai-hoc/lop/detail/:maLop'),
                maLop = route.parse(window.location.pathname).maLop;
            this.props.getSdhLopData(maLop, (data) => {
    ...
    saveChange = () => {
        ...
        T.confirm('Lưu thay đổi', 'Bạn có chắc muốn lưu thay đổi với lớp này?', true, isConfirm => {
            if (isConfirm) {
                this.props.updateSdhLopData(dataLop.ma, changes, () => {
                    this.props.getSdhLopData(dataLop.ma, (data) => {
                        this.setState({
    ...
    render() {
        ...
        const { currentDataLop } = this.props.sdhLopHocVien && this.props.sdhLopHocVien.currentDataLop ? this.props.sdhLopHocVien : { currentDataLop: { dsSinhVien: [], dsTuDong: [] } };
        ...
        return this.renderPage({
            ...
            content: <>
                        ...
                        {dataLop && (
                            <>
                                <div className='col-md-4'>
                                    <span >Mã lớp: </span>
                                    <b >{dataLop.ma || ''}</b><br /><br />
                                </div>
                                <div className='col-md-4'>
                                    <span >Mã ngành: </span>
                                    <b >{dataLop.nganh || ''}</b><br /><br />
                                </div>
                                <div className='col-md-4'>
                                    <span >Niên khóa: </span>
                ...
                <div className='tile'>
                    <FormSelect className='mt-3' label='Chọn sinh viên để thêm vô lớp' placeholder='Chọn sinh viên' ref={e => this.addSelectStudent = e} data={SelectAdapter_DangKyHocPhanStudentSdh} />
                ...
                <ImportSinhVienSdhModal ref={e => this.importModal = e} update={this.addDsImport} />
            </>,
...
const mapActionsToProps = {
    getLopCommonPage, getSdhLopData, updateSdhLopData
};
