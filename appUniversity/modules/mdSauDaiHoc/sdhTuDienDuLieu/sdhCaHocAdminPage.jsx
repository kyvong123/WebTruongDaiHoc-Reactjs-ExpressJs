...
import { createDmCaHoc, getDmCaHocAll, updateDmCaHoc, deleteDmCaHoc } from 'modules/mdDanhMuc/dmCaHoc/redux';
...
import { SelectAdapter_DtDmBuoiHoc } from 'modules/mdDaoTao/dtDmBuoiHoc/redux';
...
class SdhCaHocAdminPage extends AdminPage {
...
export default connect(mapStateToProps, mapActionsToProps)(SdhCaHocAdminPage);
