...
class SdhToaNhaPage extends AdminPage {
    componentDidMount() {
        T.ready('/user/sau-dai-hoc', () => this.props.getDmToaNhaAll());
...
const mapStateToProps = state => ({ system: state.system, dmToaNha: state.danhMuc.dmToaNha, });
const mapActionsToProps = { getDmCoSoAll, getDmToaNhaAll, createDmToaNha, updateDmToaNha, deleteDmToaNha };
export default connect(mapStateToProps, mapActionsToProps)(SdhToaNhaPage);