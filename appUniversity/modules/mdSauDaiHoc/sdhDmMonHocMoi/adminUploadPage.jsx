...
class AdminSvSdhUploadPage extends AdminPage {
    ...
    downloadExcel = () => {
        T.handleDownload('/api/sdh/mon-hoc-moi/download-template', 'Mon_hoc_Template.xlsx');
    }
    ...
    dangKy = e => {
        ...
        if (list.length == 0) {
            ...
            this.props.createDmMonHocSdhMoiMutiple(list, () => {
    ...
    renderKetQuaImport = (list) => renderDataTable({
        ...
        renderRow: (item, index) => (
            <tr key={index}>
                ...
                <TableCell style={{ whiteSpace: 'nowrap' }} content={item.tenTiengViet} />
                <TableCell style={{ whiteSpace: 'nowrap' }} content={item.tenTiengAnh} />
                <TableCell style={{ textAlign: 'center', whiteSpace: 'nowrap' }} content={item.tenKhoa} />
                <TableCell style={{ textAlign: 'center', whiteSpace: 'nowrap' }} content={item.tcLyThuyet} />
                <TableCell style={{ textAlign: 'center', whiteSpace: 'nowrap' }} content={item.tcThucHanh} />
    ...
    render() {
        ...
        return this.renderPage({
            ...
            breadcrumb: [
                ...
                <Link key={1} to='/user/sau-dai-hoc/mon-hoc-moi'>Danh sách Môn Học</Link>,
                'Import Môn Học'
            ],
            content: <div>
                <div className='tile'>
                    <div className='tile-body'>
                        ...
                        <div className='rows' style={{ textAlign: 'right', display: displayState == 'import' ? 'block' : 'none', }}>
                            ...
                            <FileBox postUrl={'/user/upload'} uploadType='dmMonHocSdhMoiImportData' userData={'dmMonHocSdhMoiImportData'}
