...
import { getTccbDanhGiaChuyenVienUser, createTccbDanhGiaGiangDayUser, deleteTccbDanhGiaGiangDayUser } from './redux/redux';
...
class FormChuyenVienDetails extends AdminPage {
    ...
    componentDidMount() {
        T.ready('/user', () => {
            const route = T.routeMatcher('/user/info/danh-gia-giang-day/:nam').parse(window.location.pathname);
    ...
    createNoiDung = (item, done) => {
        this.props.createTccbDanhGiaGiangDayUser(item, () => this.load(done));
    }

    deleteNoiDung = (item) => {
        T.confirm('Xóa đăng ký', 'Bạn có chắc muốn xóa đăng ký này?', 'info', isConfirm => {
            isConfirm && this.props.deleteTccbDanhGiaGiangDayUser(item.id, item.nam, () => this.load());
        });
    }
...
const mapActionsToProps = { getTccbDanhGiaChuyenVienUser, createTccbDanhGiaGiangDayUser, deleteTccbDanhGiaGiangDayUser, updateTccbDanhGiaCaNhanDiemThuongUser, getTccbKhungDanhGiaCanBoAll, createTccbDanhGiaCaNhanDiemThuongUser, deleteTccbDanhGiaCaNhanDiemThuongUser };
