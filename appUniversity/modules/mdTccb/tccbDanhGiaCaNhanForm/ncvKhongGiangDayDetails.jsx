...
import { getTccbDanhGiaChuyenVien, createDanhGiaKhongGiangDayByUnit, deleteDanhGiaChuyenVienByUnit, getTccbKhungDanhGiaCanBoAll } from './redux/redux';
...
class FormChuyenVienDetails extends AdminPage {
    ...
    componentDidMount() {
        T.ready('/user/tccb', () => {
            const route = T.routeMatcher('/user/tccb/danh-gia-khong-giang-day/:nam/:shcc');
    ...
    createNoiDung = (item, done) => {
        this.props.createDanhGiaKhongGiangDayByUnit(item, () => this.load(done));
    }
...
const mapActionsToProps = { getTccbDanhGiaChuyenVien, createDanhGiaKhongGiangDayByUnit, deleteDanhGiaChuyenVienByUnit, createTccbDanhGiaCaNhanDiemThuong, getTccbKhungDanhGiaCanBoAll, updateTccbDanhGiaCaNhanDiemThuong, deleteTccbDanhGiaCaNhanDiemThuong };
