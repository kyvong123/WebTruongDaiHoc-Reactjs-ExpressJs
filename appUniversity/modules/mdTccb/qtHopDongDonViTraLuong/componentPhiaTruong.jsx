...
import { suggestSoHopDong, getTruongPhongTccb } from './redux';
import { getDaiDienKyHopDong } from 'modules/mdTccb/qtHopDongLaoDong/redux';

export class ComponentPhiaTruong extends React.Component {
    componentDidMount() {
        const { schoolName } = this.props.system ? this.props.system : { schoolName: '' };
    ...
    setVal = (data = null) => {
        if (data) {
            ...
            this.soHopDong.value(this.state.suggestSoHopDong + '/' + curYear + '/HĐĐV-XHNV-TCCB');
            this.props.getTruongPhongTccb(data => {
