...
module.exports = app => {
    ...
    const methods = {
        'getHV': 'QT_DAO_TAO_GET_HOC_VI_CAN_BO',
        'searchPage': 'QT_DAO_TAO_SEARCH_PAGE',
        'groupPage': 'QT_DAO_TAO_GROUP_PAGE',
        'getCurrentOfStaff': 'QT_DAO_TAO_GET_CURRENT_OF_STAFF',
        'download': 'QT_DAO_TAO_DOWNLOAD_EXCEL'
    };
    app.model.qtDaoTao = {
