// Table name: DM_CHUC_VU { ma, ten, phuCap, kichHoat, ghiChu, loaiChucVu, isCapTruong, truong, pho }
const keys = ['MA'];
const obj2Db = { 'ma': 'MA', 'ten': 'TEN', 'phuCap': 'PHU_CAP', 'kichHoat': 'KICH_HOAT', 'ghiChu': 'GHI_CHU', 'loaiChucVu': 'LOAI_CHUC_VU', 'isCapTruong': 'IS_CAP_TRUONG', 'truong': 'TRUONG', 'pho': 'PHO' };

module.exports = app => {
    const db = 'main';
    const tableName = 'DM_CHUC_VU';
    const type = 'table';
    const schema = {
        MA: {
            type: 'NVARCHAR2',
