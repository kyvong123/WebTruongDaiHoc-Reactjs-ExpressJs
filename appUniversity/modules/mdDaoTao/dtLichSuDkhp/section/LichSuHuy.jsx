...
import { getDtLichSuDkhpDashBoard, hoanTacDtLichSuDkhpXoa } from 'modules/mdDaoTao/dtLichSuDkhp/redux';
import { connect } from 'react-redux';
import Pagination from 'view/component/Pagination';
import { Tooltip } from '@mui/material';
class LichSuHuy extends AdminPage {
    state = {
    ...
    getLichSu = (done) => {
        this.setState({ filter: { ...this.props.filter, thaoTac: 'D' } }, () => {
    ...
    hoanTac = (item) => {
        this.props.hoanTacDtLichSuDkhpXoa(item);
        console.log(item);
    }
                ...
                return (
                    <tr key={index}>
                        ...
                        <TableCell style={{ whiteSpace: 'nowrap', textAlign: 'center' }} content={
                            <div style={{ color: 'red' }}><i className='fa fa-lg fa-times-circle-o' /> Hủy đăng ký </div>
...
const mapActionsToProps = {
    getDtLichSuDkhpDashBoard, hoanTacDtLichSuDkhpXoa
};
export default connect(null, mapActionsToProps, null, { forwardRef: true })(LichSuHuy);