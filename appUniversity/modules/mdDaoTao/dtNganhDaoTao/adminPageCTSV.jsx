...
class DtNganhPage extends AdminPage {
    ...
    render() {
        ...
        return this.renderPage({
            ...
            header: permissionNganhDaoTao.read && <FormSelect ref={e => this.khoaFilter = e} data={SelectAdapter_DmDonViFaculty_V2} style={{ width: '400px', marginBottom: '0' }} placeholder='Chọn khoa/bộ môn' onChange={this.filterKhoa} allowClear />,
