// Table name: DT_KHUNG_DAO_TAO { id, namDaoTao, maKhoa, maNganh, tenNganh, trinhDoDaoTao, loaiHinhDaoTao, thoiGianDaoTao, tenVanBang, userModified, lastModified, mucTieu, chuyenNganh, khoaSinhVien, maCtdt, maKhung, dotTrungTuyen }
const keys = ['ID'];
const obj2Db = { 'id': 'ID', 'namDaoTao': 'NAM_DAO_TAO', 'maKhoa': 'MA_KHOA', 'maNganh': 'MA_NGANH', 'tenNganh': 'TEN_NGANH', 'trinhDoDaoTao': 'TRINH_DO_DAO_TAO', 'loaiHinhDaoTao': 'LOAI_HINH_DAO_TAO', 'thoiGianDaoTao': 'THOI_GIAN_DAO_TAO', 'tenVanBang': 'TEN_VAN_BANG', 'userModified': 'USER_MODIFIED', 'lastModified': 'LAST_MODIFIED', 'mucTieu': 'MUC_TIEU', 'chuyenNganh': 'CHUYEN_NGANH', 'khoaSinhVien': 'KHOA_SINH_VIEN', 'maCtdt': 'MA_CTDT', 'maKhung': 'MA_KHUNG', 'dotTrungTuyen': 'DOT_TRUNG_TUYEN' };

module.exports = app => {
    const db = 'main';
    const tableName = 'DT_KHUNG_DAO_TAO';
    const type = 'table';
    const schema = {
        ID: {
            type: 'NUMBER',
    ...
    const methods = {
        'searchPage': 'DT_KHUNG_DAO_TAO_SEARCH_PAGE',
        'khungDtGetAll': 'DT_KHUNG_DAO_TAO_GET_ALL'
    };
    app.model.dtKhungDaoTao = {
        ...
        khungDtGetAll: (filter, done) => new Promise((resolve, reject) => {
            app.database.oracle.connection.main.executeExtra('BEGIN :ret:=dt_khung_dao_tao_get_all(:filter); END;',
